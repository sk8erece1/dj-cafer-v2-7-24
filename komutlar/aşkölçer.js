...
exports.run = async (client, message, args) => {
        ...
        if(anasonuc < 80) {
                var yorum = 'Biraz Daha Uğraşırsan Bu İş Olacak Gibi :)'
        }
        if(anasonuc < 60) {
        ...
        if(anasonuc < 20) {
                var yorum = 'Bu İş Olmaz Sen Bunu Unut.'
        }
        const embed = new Discord.RichEmbed()
...
exports.conf = {
        enabled: true,
        guildOnly: true,
        aliases: ['aşk-ölçer', 'ask-olcer', 'askolcer', 'ask', 'aşk', 'aşkölçer '],
        permLevel: 0
}
...
exports.help = {
        ...
        usage: 'aşkölç [@Kullanıcı] [@Kullanıcı]'
}